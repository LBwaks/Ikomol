...
class Blog(models.Model):
    ...
    slug = AutoSlugField(
        populate_from="title", slugify_function=my_slugify_function, unique=True
    )
    tag = models.ForeignKey(Tag, on_delete=models.CASCADE, related_name="blog_tag")
    description = RichTextField()
    photo = models.ImageField(
        upload_to="blogs/blog_images/",
    )
...
class Comment(models.Model):
    blog = models.ForeignKey(
        "Blog", related_name="comments", on_delete=models.CASCADE, null=False
    )
